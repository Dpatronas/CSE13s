...
// This should call the ll_lookup() function to ensure its not already present
// in hashtable  if there is an oldspeak present handle it!  ht:
// The HashTable  gs:			The Hatterspeak to add to the
// HashTable (hash the oldspeak = key)
//
