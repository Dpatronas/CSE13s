...
=======
    // insert the new struct into the hashtable
    ht_insert(ht, new_hs);
>>>>>>> 7ef6efec74e2edd19039938d0d41cc2e320c8df0
  }
  fclose(os_txt);
}
...
>>>>>>> 7ef6efec74e2edd19039938d0d41cc2e320c8df0
  ...
  // print the letter
    ...
    if (error_letter && trans_letter) {
      printf("Dear Comrade,");
      printf("\n\nYou have chosen to use words that the queen has decreed "
             "oldspeak.");
      printf("\nDue to your infraction you will be sent to the dungeon where "
             "you will be taught hatterspeak.");
      printf("\n\nYour errors:\n\n");
      ll_print(&forbidden);
      ...
      printf("Dear Comrade,");
      printf("\n\nThe decree for hatterspeak finds your message lacking. Some "
             "of the words that you used are not hatterspeak.");
