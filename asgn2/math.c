...
double Exp(double x) {
  ...
  //nth term > 0th term
    ...
    //while ( |(n) - (n-1)| > threshold ), continue adding terms to increase precision
    while ( difference > EPSILON) {
      ...
      difference = ( fabs(first - second) );  //determine the difference between two terms
...
double Sin(double x) {
  ...
  numerator = (x*(((( x_Sqr * (52785432-( 479249 * x_Sqr))) - 1640635920 ) * x_Sqr ) + 11511339840));

  denominator = ((((((18361 * x_Sqr) + 3177720) * x_Sqr) + 277920720 ) * x_Sqr) + 11511339840 );
...
double Cos(double x) {
  ...
  numerator = ((x_Sqr * (1075032 - (14615 * x_Sqr)) - 18471600) * x_Sqr ) + 39251520;
...
double Tan(double x) {
  double x_Sqr = Pow(x,2);
  double numerator = (x * ((((x_Sqr * ((x_Sqr - 990) * x_Sqr ) + 135135) - 4729725) * x_Sqr )+ 34459425));
  double denominator = ((((x_Sqr * ((((45 * x_Sqr) - 13860) * x_Sqr ) + 945945) - 16216200)) * x_Sqr ) + 34459425 );
  return numerator / denominator;
}
